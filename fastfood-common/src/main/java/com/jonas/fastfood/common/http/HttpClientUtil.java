...
public class HttpClientUtil {
     ...
     * 收集上下文中的数据, 以便记录日志
     */
    private static String collectContext(long start, String method, String url, String params, String result) {
        ...
        try (CloseableHttpResponse response = createHttpClient().execute(request, HttpClientContext.create())) {
            ...
            if (U.isNotBlank(entity)) {
                ...
                if (LogUtil.ROOT_LOG.isInfoEnabled()) {
                    String log = collectContext(start, method, url, params, result);
