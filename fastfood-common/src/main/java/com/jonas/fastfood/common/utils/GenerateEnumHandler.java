            ...
            for (File file : packageParent.listFiles()) {
                ...
                try {
                    ...
                    if (aClass != null && aClass.isEnum()) {
                        ...
                        String parent = clazz.getClassLoader().getResource("").getPath().replace("target/classes", "src/main/java").replace("target/test-classes", "src/main/java").replace(packName.replace(".", "/"), generate.replace(".", "/"));
